...
var (
	...
	// Debugging flags.
	debugLog        = flag.String("debug-log", "/mydata/runtime_log/", "additional location for logs. If it ends with '/', log files are created inside the directory with default names. The following variables are available: %TIMESTAMP%, %COMMAND%.")
